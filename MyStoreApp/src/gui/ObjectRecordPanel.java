 ...
 * @author FOyeyipo
 */
public class ObjectRecordPanel extends javax.swing.JFrame {
     ...
     */
    public ObjectRecordPanel(IRecordsStorage iRecordsStorage) {
        initComponents();
        loadComboBox();
    ...
    public void clear(){
        ...
        objectType.setSelectedItem(null);
        condition.setSelectedItem(null);
        recordType.setSelectedItem(null);
    ...
    public void getItem(){
        ...
        String obj = (String) objectType.getSelectedItem();
        String condi = (String) condition.getSelectedItem();
        String recorded = (String) recordType.getSelectedItem();
        
        var objectI = new ObjectItem(ObjectType.valueOf(obj), descrpt, Double.parseDouble(value), Condition.valueOf(condi), RecordType.valueOf(recorded));
        
                iRecordsStorage.retrieveRecordToDisplay(RecordType.valueOf(recorded));
    }
